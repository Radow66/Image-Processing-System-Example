...
#
# Script generated by Vivado on Thu Jan 09 23:00:18 +0300 2025
...
export RDI_DATADIR="E:/Vivado/2024.2/data"

# set xvlog options
xvlog_opts="--incr --relax "

# script info
echo -e "blk_mem_gen_2.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L blk_mem_gen_v8_4_9 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot blk_mem_gen_2 xil_defaultlib.blk_mem_gen_2 xil_defaultlib.glbl -log elaborate.log
}
